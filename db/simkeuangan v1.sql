...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Jul 2020 pada 02.06
...
INSERT INTO `bos_realisasi_rekapitulasi` (`id`, `idsnp`, `sub_program_id`, `saldo`, `tahun_ajaran`) VALUES
(1, '2', '11', NULL, NULL),
(2, '1', '1', NULL, NULL);
...
INSERT INTO `bos_rkas` (`id`, `npsn`, `sub_program`, `tahun_ajaran`, `nip`, `tipe`, `dibuat_tanggal`) VALUES
...
INSERT INTO `bos_rkas_rencana` (`id`, `tahun`, `jumlah_siswa`, `dana_siswa`, `tanggal_dibuat`, `dibuat_oleh`) VALUES
...
INSERT INTO `gaji_guru` (`id`, `status`, `masa_kerja`, `nominal`, `tahun`) VALUES
(1, 0, 0, 30000, '2018');
...
CREATE TABLE `tbl_gaji` (
  `id` varchar(8) NOT NULL,
  `nip` varchar(25) DEFAULT NULL,
  `tunjangan_id` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Struktur dari tabel `tbl_penerimaan_pengeluaran`
--

CREATE TABLE `tbl_penerimaan_pengeluaran` (
  `id` varchar(8) NOT NULL,
  `uraian` varchar(255) DEFAULT NULL,
  `tanggal` date DEFAULT NULL,
  `status` varchar(150) DEFAULT NULL,
  `kategori_spp_id` varchar(8) DEFAULT NULL,
  `gaji_id` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `tbl_penerimaan_pengeluaran`
--
ALTER TABLE `tbl_penerimaan_pengeluaran`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kategori_spp_id` (`kategori_spp_id`),
...
ALTER TABLE `bos_rkas`
  ...
  ADD CONSTRAINT `bos_rkas_ibfk_4` FOREIGN KEY (`nip`) REFERENCES `tbl_pegawai` (`nip`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tbl_gaji`
  ADD CONSTRAINT `tbl_gaji_ibfk_1` FOREIGN KEY (`nip`) REFERENCES `tbl_pegawai` (`nip`),
  ADD CONSTRAINT `tbl_gaji_ibfk_2` FOREIGN KEY (`tunjangan_id`) REFERENCES `tbl_tunjangan` (`id`);
...
--
-- Ketidakleluasaan untuk tabel `tbl_penerimaan_pengeluaran`
--
ALTER TABLE `tbl_penerimaan_pengeluaran`
  ADD CONSTRAINT `tbl_penerimaan_pengeluaran_ibfk_1` FOREIGN KEY (`kategori_spp_id`) REFERENCES `tbl_kategori_spp` (`id`),
  ADD CONSTRAINT `tbl_penerimaan_pengeluaran_ibfk_2` FOREIGN KEY (`gaji_id`) REFERENCES `tbl_gaji` (`id`);
